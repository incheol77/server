...
/*
  Allow to set an onbject definer:
...
/* Actions that require the SUPER privilege */
...
*/
constexpr privilege_t PRIV_STMT_SHOW_BINLOG_STATUS= REPL_CLIENT_ACL;

// Was SUPER_ACL | REPL_CLIENT_ACL prior to 10.5.2
constexpr privilege_t PRIV_STMT_SHOW_BINARY_LOGS= REPL_CLIENT_ACL;

// Was SUPER_ACL prior to 10.5.2
constexpr privilege_t PRIV_STMT_PURGE_BINLOG= BINLOG_ADMIN_ACL;

// Was REPL_SLAVE_ACL prior to 10.5.2
constexpr privilege_t PRIV_STMT_SHOW_BINLOG_EVENTS= PROCESS_ACL;
...
// Was (SUPER_ACL | REPL_CLIENT_ACL) prior to 10.5.2
constexpr privilege_t PRIV_STMT_SHOW_SLAVE_STATUS= REPL_SLAVE_ADMIN_ACL;
// Was SUPER_ACL prior to 10.5.2
constexpr privilege_t PRIV_STMT_BINLOG= REPL_SLAVE_ADMIN_ACL;
// Was REPL_SLAVE_ACL prior to 10.5.2
